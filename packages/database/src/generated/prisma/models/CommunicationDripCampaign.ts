...
export type CommunicationDripCampaignAggregateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
   ...
   *
   * Take `±n` CommunicationDripCampaigns from the position of the cursor.
   */
  take?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type GetCommunicationDripCampaignGroupByPayload<T extends CommunicationDripCampaignGroupByArgs> = Prisma.PrismaPromise<
  Array<
