...
4. Complete the authenticated admin dashboard and member portal retest in a real browser. Marketing → Google sign-in → church creation → Growth trial checkout passed; the admin session handoff still needs retesting after the preview deployment.
